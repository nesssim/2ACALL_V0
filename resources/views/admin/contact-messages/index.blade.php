...
@section('content')
    <div x-data="contactMessages()">
        <!-- Enhanced Header - Modern & Clean -->
        <!-- Refined Header for Contact Messages -->
<div class="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-teal-800 to-cyan-700 rounded-3xl p-8 text-white shadow-2xl">
    
    <!-- Subtle animated background elements -->
    <div class="absolute inset-0 -z-10">
        <div class="absolute -top-10 -left-10 w-60 h-60 bg-gradient-to-r from-green-400 to-cyan-500 rounded-full opacity-20 filter blur-3xl animate-pulse"></div>
        <div class="absolute -bottom-10 -right-10 w-72 h-72 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full opacity-20 filter blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
    </div>
    ...
    <div class="relative z-10 flex items-center justify-between">
        <div class="flex items-center space-x-5">
            ...
            <div class="relative">
                ...
                <div class="absolute -top-1.5 -right-1.5 w-5 h-5 bg-pink-500 rounded-full border-2 border-teal-700 flex items-center justify-center">
                    <div class="absolute inset-0 bg-pink-400 rounded-full animate-ping"></div>
                    <span class="relative text-xs font-bold">3</span>
                </div>
            </div>
            
            <div>
                <h1 class="text-4xl font-black mb-1 bg-gradient-to-r from-white via-green-100 to-white bg-clip-text text-transparent drop-shadow-sm">
                    Messages de contact
                </h1>
    ...
    <!-- Bottom Accent Line -->
    <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-green-400 via-cyan-500 to-blue-500 opacity-70"></div>
</div>
...
<style>
    ...
    .animate-shimmer {
                    ...
                    <thead class="bg-gradient-to-r from-blue-50 to-indigo-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Contact</th>
                            <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sujet
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Statut</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200" :id="'message-row-' + {{ $msg->id }}">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">{{ $msg->first_name }}
                                                {{ $msg->last_name }}</div>
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            <div @click.away="closeModal()" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="flex-1 overflow-y-auto p-6">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 mb-6">
                                <div class="flex items-center mb-4">
                                    <div
                                        class="h-12 w-12 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center mr-4">
                                        <span class="text-lg font-medium text-white"
                                            x-text="message.first_name.charAt(0) + message.last_name.charAt(0)"></span>
                                    </div>
                                    <div>
                                        <h4 class="text-lg font-semibold text-gray-900"
                                            x-text="message.first_name + ' ' + message.last_name"></h4>
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span x-text="capitalizeFirst(currentStatus)"
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-lg font-medium text-gray-900 bg-white border border-gray-200 rounded-lg p-3 break-words"
                                    x-text="message.subject"></p>
                            </div>
                            ...
                            <div x-show="message.admin_notes" class="mb-6">
                                <h5 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Notes
                                    administrateur</h5>
                        ...
                        <div class="border-t border-gray-200 px-6 py-4 bg-gray-50">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <button x-show="currentStatus === 'nouveau'" @click="markAsRead()" :disabled="loading"
                                    ...
                                    <button x-show="currentStatus !== 'fermé' && currentStatus !== 'traité'"
                                        @click="markAsTreated()" :disabled="loading"
