<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <p class="text-blue-100">Rejoignez notre plateforme dès aujourd'hui</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Nom complet')" class="text-white font-semibold mb-2 block" />
            <div class="relative">
        ...
        <div class="space-y-4">
            ...
            <div class="text-center">
                <span class="text-blue-100">Déjà un compte ?</span>
                <a href="{{ route('login') }}" class="ml-1 text-white font-semibold hover:text-blue-200 transition-colors duration-200">
                    Se connecter
                </a>
            </div>
        </div>
